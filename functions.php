...
function sg_sticky_mobile() {
    ...
    echo '
  	...
  	<style>
  		.sticky {text-align: center; height: 44px; position: initial; }
  		.sticky a {position: fixed;z-index: 999; width: 100%; margin: 0; background: rgb(237,180,169);background: linear-gradient(45deg, rgba(237,180,169,1) 0%, rgba(179,111,102,1) 100%); color: #4b4b4e;padding: 10px 15px; display: block; text-align: center; text-decoration: none; font-size: 18px; cursor: pointer; font-weight:bold;  }
